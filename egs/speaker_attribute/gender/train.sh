...
#
# Example
# CUDA_VISIBLE_DEVICES=1,2,3,4,5 bash train.sh --config egs/speaker_attribute/gender/config/mel_gender_predictor.yaml \
...
config="egs/speaker_attribute/gender/config/mel_gender_predictor.yaml"
log_dir="${script_dir}/results/20241203_gender_mel"
nnodes=1
nproc_per_node=-1
num_workers=8
resume=0
