...
#
# Example
# CUDA_VISIBLE_DEVICES=1,2,3,4,5 bash train.sh --config egs/codec/bigcodec/config/bigcodec.yaml \
#               --log_dir egs/codec/bigcodec/results/20241205_bigcodec \
#               --nproc_per_node 5
...
config="egs/codec/bigcodec/config/bigcodec.yaml"
log_dir="${script_dir}/results/20241206_bigcodec"
nnodes=1
nproc_per_node=8
num_workers=8
resume=0
