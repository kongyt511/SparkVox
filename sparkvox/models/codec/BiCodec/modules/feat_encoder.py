...
from sparkvox.models.base.blocks.vocos import VocosBackbone
from sparkvox.models.base.blocks.samper import SamplingBlock
...
if __name__ == '__main__':
    ...
    encoder = Encoder(input_channels=1024, vocos_dim=384, vocos_intermediate_dim=2048, vocos_num_layers=12, out_channels=256, sample_ratios= [2,2])
