...
class spark-ttsDataCollator(DataCollatorForLanguageModeling):
    def __init__(
        self,
        task: str,          
        tokenizer_path: Path,
    ...
    def parser_tts(self, example):
        

    def parser_control_tts(self, example):

    def parser_understand(self, example):
