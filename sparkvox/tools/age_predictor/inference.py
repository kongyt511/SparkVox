...
# Post-processing function to convert logits to age prediction
...
def main():
    ...
    parser.add_argument(
        "--config_path",
        type=str,
        default="/aifs4su/xinshengwang/code/spark-tts/sparkvox/egs/speaker_attribute/age/config/wavlm_age_ft.yaml",
    )
    parser.add_argument(
        "--ckpt_path",
        type=str,
        default="/aifs4su/xinshengwang/code/spark-tts/sparkvox/egs/speaker_attribute/age/results/20250105_wavlm_age_ft/20250105_185159/ckpt/epoch=0001_step=013013_agg_val_acc=0.95_agg_val_ce_loss=0.16.ckpt",
    )
    parser.add_argument(
        "--save_path",
        type=str,
        default="/aifs4su/mmdata/processed_data/spark-tts/AGE_DATA",
    )
    ...
    model = AgePredictor.load_from_checkpoint(args.ckpt_path)
